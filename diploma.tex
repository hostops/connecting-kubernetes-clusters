...
\newcommand{\tkeywords}{gruča, oblak, Kubernetes, računalniški klaster, povezovanje klastrov, mreža klastrov,  KubeFed, Cilium, GitOps, Argo CD}
\newcommand{\tkeywordsEn}{cluster, cloud, Kubernetes, computer cluster, connecting clusters, cluster mesh,  KubeFed, Cilium, GitOps, Argo CD}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%	HYPERREF SETUP
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
To reši marsikatero težavo v računalništvu in vsaj teoretično je to dovolj, da imamo visoko dosegljivost naših storitev ~\cite{mastering-kubernetes} in sinhrono delovanje večih računalnikov.
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.6\textwidth]{images/problem-prevelike-latence.png}
\end{center}
