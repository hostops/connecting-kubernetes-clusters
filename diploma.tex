...
V našem primeru spletne aplikacije bomo imeli v vsaki gruči eno postavitev aplikacije \sn{Stateful rest sample} (objekt deployment). 
...
\section{Zmanjševanje posledic vdorov in izpadov}
  Računalniška stroka si je že nekaj časa nazaj priznala, da popolnega sistema ne more ustvariti: sistema, ki se ne more sesuti, sistema, ki bo ves čas dosegljiv in sistema, v katerega ne bo mogoče vdreti.
...
Kljub temu, da smo naše aplikacije namestili na različne gruče in je s tem aplikacija odporna na izpad ene gruče ga ob hujših nepravilnostih delovanja aplikacije in nastavitev gruče lahko zaradi napake na eni aplikaciji kaskadno izpadejo tudi vse gruče na katerih imamo aplikacijo nameščeno.
