...
\subsection{Prevelika latenca~\cite{minimizing-latency}}
...
\end{figure}
\subsection{Višja razpoložljivost~\cite{ha-systems}}
...
\section{Zgodovina~\cite{mastering-kubernetes}~\cite{borg-omega-kubernetes}}
...
\section{Problem velike latence~\cite{minimizing-latency}}
...
Ko imamo na vsaki gruči javno izpostavljen Kubernetesov service objekt in postavljene primerne objekte ingress, moramo še vedno uporabnike preusmeriti na njim najbližjo gručo.
...
\subsection{Vdori~\cite{securing-kube}}
